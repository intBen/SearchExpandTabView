 ...
 */
public class SearchSysParamAdapter extends ArrayAdapter<SysParamsBean> {
    ...
    * @param type 
    */
    public SearchSysParamAdapter(Context context, List<SysParamsBean> listData, int sId, int nId, int type) {
